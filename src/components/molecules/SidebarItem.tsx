        ...
        <>
          <div className="relative shrink-0">
            ...
            {typeof badge === 'number' && badge > 0 && (
              <span className="absolute -top-2 -right-2 bg-red-500 text-itec-texttext-[8px] font-bold px-1.5 py-0.5 rounded-full border-2 border-itec-bg flex items-center justify-center">
                {badge}
              </span>
            )}
          </div>
