...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Overlay oscuro: debe quedar DEBAJO del drawer (z-40) */}
      <div
      ...
      {/* Drawer: debe quedar POR ENCIMA del overlay (z-50) para recibir los clicks/taps */}
      <div
        className={`md:hidden fixed top-0 left-0 z-50 h-full w-64 transform transition-transform duration-300 ease-in-out ${
