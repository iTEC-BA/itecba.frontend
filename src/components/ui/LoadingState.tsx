  ...
  return (
    <div className="flex h-dvh w-full flex-col items-center justify-center gap-4 bg-itec-bg">
      <div className="relative w-42 h-42 flex items-center justify-center scale-90 md:scale-100">
        ...
        <div className="absolute inset-0 rounded-full border-[6px] border-itec-border/50 animate-[spin_12s_linear_infinite] scale-105"></div>
        ...
        <div className="absolute inset-2 rounded-full border-2 border-dashed border-itec-border/50 animate-[spin_4s_ease-in-out_infinite_reverse] scale-98"></div>
