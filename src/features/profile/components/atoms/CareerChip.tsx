...
export const CareerChip: React.FC<CareerChipProps> = ({
  label, code, colorClass, active = true, sm = false,
}) => (
  <span className={cn(
    "inline-flex items-center gap-1.5 border rounded-xl font-bold",
    ...
    {code && (
      <span className="text-[9px] font-black opacity-60">{code}</span>
    )}
    {label}
  </span>
);
