    ...
    <section className="mb-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 bg-gradient-to-br from-itec-box to-itec-sidebar border border-itec-gray rounded-xl p-8 shadow-xl flex flex-col items-center justify-center relative overflow-hidden group hover:border-red-500/30 transition-all text-center">
          ...
          <h3 className="text-itec-textfont-bold text-xl mb-1 tracking-wide">ITEC UTN BA</h3>
          <p className="text-xs text-itec-text font-medium uppercase tracking-widest">
        ...
        <div className="bg-itec-box border border-itec-gray p-6 rounded-xl hover:bg-itec-sidebar transition-colors shadow-lg flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-itec-text leading-tight">Acceso libre a miles de resúmenes, parciales y guías sin costo alguno.</p>
          </div>
        </div>
        ...
        <div className="bg-itec-box border border-itec-gray p-6 rounded-xl hover:bg-itec-sidebar transition-colors shadow-lg flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-itec-text leading-tight">Encontrá tu grupo de WhatsApp por materia y comisión al instante.</p>
          </div>
        </div>
        ...
        <div className="bg-itec-box border border-itec-gray p-6 rounded-xl hover:bg-itec-sidebar transition-colors shadow-lg flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-itec-text leading-tight">Agregamos nuevas secciones y herramientas útiles cada cuatrimestre.</p>
          </div>
        </div>
