    ...
    <MainLayout>
      <main className="px-4 pb-24 overflow-x-hidden">
        ...
        <section className="py-8 w-full mx-auto container lg:max-w-4xl md:max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
          ...
          <ol className="relative mt-8 border-l-2 border-itec-border/50 ml-3 md:ml-4">
        ...
        <section className="py-16 w-full mx-auto container lg:max-w-4xl md:max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400">
          <div className="mb-12 border-b border-itec-border/50 pb-4">
            <h2 className="flex items-center text-2xl md:text-3xl font-bold tracking-tight gap-x-3 text-itec-text">
            ...
            {PROJECTS_DATA.items.map((project) => (
              <article key={project.id} className="flex flex-col md:flex-row gap-6 md:gap-10 group">
                ...
                <div className="w-full md:w-1/2">
                  <div className="relative flex flex-col items-center overflow-hidden rounded-xl border border-itec-border/50 bg-itec-box p-8 md:p-12 transition-colors duration-300 group-hover:border-itec-muted">
                    <img 
                      alt={project.title} 
                  ...
                  <footer className="flex items-center mt-6 gap-x-3">
                    {project.links.map((link, i) => (
                      <Link 
                        key={i} 
                        to={link.url} 
                        className="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-xs font-bold text-itec-text transition-colors bg-itec-surface border border-itec-border/50 rounded-xl hover:bg-itec-box hover:text-white"
                      >
        ...
        <section className="py-16 w-full mx-auto container lg:max-w-4xl md:max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500">
          <div className="mb-10 border-b border-itec-border/50 pb-4">
            <h2 className="flex items-center text-2xl md:text-3xl font-bold tracking-tight gap-x-3 text-itec-text">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-stretch">
            ...
            <div className="w-full md:w-3/5 flex flex-col justify-center gap-6 bg-itec-box border border-itec-border/50 rounded-2xl p-8 sm:p-10 relative overflow-hidden">
                    ...
                    {team?.map((user, index) => {
                      ...
                      return (
                        <div key={index} className="group/avatar relative transition-transform hover:-translate-y-1 cursor-default">
                          ...
                          <div className="absolute -top-12 left-1/2 -translate-x-1/2 opacity-0 group-hover/avatar:opacity-100 transition-opacity duration-200 bg-itec-surface border border-itec-border/50 text-itec-text text-[10px] px-3 py-1.5 rounded-lg whitespace-nowrap z-30 pointer-events-none flex flex-col items-center font-medium tracking-wide">
                            {firstName}
                            <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-itec-surface border-r border-b border-itec-border/50 rotate-45" />
                          </div>
                        </div>
                      );
                    })}
            ...
            <div className="w-full md:w-2/5 flex">
              <div className="w-full bg-itec-red/33 border border-itec-border/50 rounded-2xl p-6 md:p-8 flex flex-col items-center justify-center text-center h-full relative overflow-hidden transition-color">
