// src/features/trueketec/components/atoms/TurnoBadge.tsx
...
const CONFIG: Record<string, { icon: React.ElementType; cls: string; label: string }> = {
  ...
  "Noche":      { icon: Moon,   cls: "bg-itec-surface text-itec-muted border-itec-border",             label: "Noche"      },
  "Cualquiera": { icon: Sun,    cls: "bg-itec-emerald/10 text-itec-emerald border-itec-emerald/20",    label: "Cualquiera" },
};
