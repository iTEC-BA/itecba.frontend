...
export const AulaCard: React.FC<Props> = ({ aula, isAdmin, onEdit, onDelete }) => {
  return (
    <article className="group relative flex flex-col gap-3 rounded-xl border border-itec-border/50 bg-itec-box p-4 transition-all duration-200 hover:border-itec-border/50 hover:bg-itec-card">
