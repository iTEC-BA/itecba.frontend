...
export const UserManagement: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      <div>
        <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-itec-muted">Gestión de Roles</p>
        <h2 className="mt-1 text-2xl font-bold tracking-tight text-itec-text flex items-center gap-2">
          <Users className="w-6 h-6 text-itec-red" />
          Usuarios
        </h2>
        <p className="text-xs text-itec-muted mt-1">
          Buscá alumnos y administrad sus permisos de acceso al panel de control.
        </p>
      </div>
