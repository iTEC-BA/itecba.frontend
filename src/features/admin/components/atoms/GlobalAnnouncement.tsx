...
export const GlobalAnnouncement: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[9999] w-[calc(100%-3rem)] sm:w-[420px] flex flex-col gap-4 pointer-events-none drop-shadow-2xl">
      <div className={`bg-itec-surface/95 backdrop-blur-xl border border-itec-gray/50 rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.8)] overflow-hidden pointer-events-auto transform transition-all duration-300 ease-out ${isExiting ? 'opacity-0 translate-x-8' : 'opacity-100 translate-x-0 animate-fade-in'}`}>
