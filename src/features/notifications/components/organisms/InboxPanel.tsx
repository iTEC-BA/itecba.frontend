  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative mb-3">
        ...
        <input type="text" placeholder="Buscar mensajes..." value={search} onChange={(e) => handleSearch(e.target.value)} className="w-full bg-itec-bg border border-itec-border/50 rounded-xl pl-8 pr-3 py-2.5 text-xs text-itec-text focus:outline-none focus:border-itec-border/50" />
      </div>
