...
export const SkeletonCard: React.FC<Props> = ({ variant = "default" }) => {
  if (variant === "featured") {
    return (
      <div className="bg-itec-card border border-white/5 rounded-3xl p-6 animate-pulse col-span-full sm:col-span-2">
  ...
  return (
    <div className="bg-itec-card border border-white/5 rounded-2xl p-5 animate-pulse">
