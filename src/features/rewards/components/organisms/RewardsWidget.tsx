      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-3">
            <h2 className="text-2xl font-bold text-itec-textflex items-center gap-2">
          ...
          <p className="text-itec-text text-sm">Intercambia tus puntos académicos por mentorías, descuentos y accesos exclusivos.</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#1a1a1a] to-[#252525] border border-[#333] px-5 py-2.5 rounded-xl flex items-center gap-3 shadow-lg">
          ...
          <div className="flex flex-col">
            <span className="text-[11px] text-itec-text uppercase tracking-wider font-semibold leading-none mb-1">Mis Puntos</span>
            <span className="text-xl font-bold text-itec-textleading-none">{pointsBalance}</span>
          </div>
        </div>
