...
export const HubNavCard: React.FC<HubNavCardProps> = ({
  ...
  <Link
    to={href}
    className={`group relative flex flex-col gap-2.5 p-4 bg-itec-box border border-itec-border/50 rounded-xl overflow-hidden transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg ${accentClass}`}
  >
