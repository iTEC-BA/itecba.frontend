...
export const SearchDropdown: React.FC<Props> = ({ results, isLoading, query, onClose }) => {
  ...
  return (
    <div className="absolute top-full left-0 right-0 mt-2 bg-itec-box border border-itec-border/50 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] overflow-hidden z-50 max-h-[70vh] flex flex-col">
      {isLoading && (
