...
export const EmptyGroupState: React.FC<Props> = ({ onAddClick }) => {
  return (
    <div className="bg-gradient-to-b from-itec-box to-itec-sidebar border border-itec-gray border-dashed rounded-3xl p-10 md:p-16 text-center shadow-2xl flex flex-col items-center justify-center relative overflow-hidden group">
      {/* Brillo de fondo */}
      ...
      <h3 className="text-xl md:text-2xl font-bold text-itec-textmb-3 relative z-10 tracking-tight">¡Sé el primero en aportar!</h3>
      <p className="text-sm text-itec-text max-w-md mx-auto mb-8 relative z-10 leading-relaxed">
      ...
      <button 
        onClick={onAddClick} 
        className="cursor-pointer bg-green-600 hover:bg-green-500 text-itec-textpx-8 py-3.5 rounded-xl text-sm font-bold transition-all hover:scale-105 shadow-[0_0_20px_rgba(34,197,94,0.3)] flex items-center gap-3 relative z-10 active:scale-95"
      >
