...
const FIELD_CLS =
  "bg-itec-bg border border-itec-border/50 text-itec-text text-sm px-3 py-2.5 rounded-xl outline-none focus:border-itec-groups/50 placeholder:text-itec-gray/50 transition-colors w-full";
...
export const AddMateriaInlineModal: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end gap-2 px-5 pb-5 border-t border-itec-border/50">
