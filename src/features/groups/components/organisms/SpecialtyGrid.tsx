    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2.5">
      {ESPECIALIDADES_DB.map((esp, i) => (
        <button
          ...
          className={`group relative bg-itec-box border border-white/[0.07] rounded-xl p-4 flex flex-col items-center justify-center text-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg overflow-hidden ${esp.colorClass} hover:border-current`}
        >
