  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {courses.map((curso) => {
        ...
        const isOficial = curso.categoria === "Oficial" || id?.startsWith("seminario") || id?.startsWith("analisis");
        const isSystem = isOficial || id?.startsWith("arquitectura") || id?.startsWith("podcast");
        return (
