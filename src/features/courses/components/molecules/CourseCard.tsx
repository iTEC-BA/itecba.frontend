    ...
    <div className="bg-slate-900/80 border border-slate-800 rounded-xl shadow-md overflow-hidden flex flex-col h-full hover:border-sky-500/50 hover:shadow-[0_8px_30px_-10px_rgba(14,165,233,0.3)] transition-all duration-300 group cursor-pointer">
      <div className="relative w-full h-28 overflow-hidden bg-slate-950 shrink-0">
        <img
          ...
          loading="lazy"
        />
        <button className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black/60 group-hover:bg-sky-600 rounded-full p-3.5 transition-colors duration-300 z-10 shadow-lg border border-white/10 group-hover:border-sky-400/50">
          <div className="w-5 h-5 text-itec-textml-0.5">
            <Icons type="playFill" />
          </div>
        </button>
        ...
        {isOficial && (
          <div className="absolute top-3 left-3 z-20 bg-itec-bg text-emerald-400 border border-emerald-500/30 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">
            Curso Itec
          </div>
        )}
      </div>
        ...
        <div className="mt-auto">
          <div className="flex items-center justify-between mb-2.5">
            <div className="flex items-center gap-1.5">
              <div className="w-4 h-4 text-itec-textml-0.5">
                <Icons type="entry" />
              </div>
