...
export const EmptyState: React.FC<Props> = ({ message }) => (
  <div className="flex flex-col items-center justify-center py-20 gap-4 border border-dashed border-white/10 rounded-2xl text-center px-6 animate-in fade-in duration-300">
