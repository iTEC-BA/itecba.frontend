...
const VIDEOS: GuiaVideo[] = [
  {
    id: "1",
    title: "GuíaTEC Ingresantes 2026 — SIU, aula virtual e inscripciones",
    author: "ITEC",
    duration: "22 min",
  ...
  {
    id: "2",
    title: "AM1 — Límites y continuidad desde cero",
    author: "Gabi N.",
    duration: "38 min",
    category: "Matemática",
    youtubeId: "dQw4w9WgXcQ",
  ...
  {
    id: "3",
    title: "AM2 — Integrales: técnicas y aplicaciones",
    author: "Jairo T.",
    duration: "45 min",
    category: "Matemática",
    youtubeId: "dQw4w9WgXcQ",
  ...
  {
    id: "4",
    title: "C++ para Ingeniería de Sistemas — Fundamentos",
    author: "Ramón M.",
    duration: "55 min",
  ...
  {
    id: "5",
    title: "PDEP — Programación funcional explicada simple",
    author: "Gabi N.",
    duration: "40 min",
    category: "Programación",
    youtubeId: "dQw4w9WgXcQ",
  ...
  {
    id: "6",
    title: "Física I — Cinemática y dinámica: parcial modelo",
    author: "Santiago G.",
    duration: "50 min",
    category: "Física",
    youtubeId: "dQw4w9WgXcQ",
  ...
  {
    id: "7",
    title: "Álgebra — Transformaciones lineales para parcial",
    author: "María L.",
    duration: "30 min",
    category: "Matemática",
    youtubeId: "dQw4w9WgXcQ",
...
export const GuiaTECPage: React.FC = () => {
  ...
  const [activeCategory, setActiveCategory] = useState<"Todas" | GuiaCategory>(
    "Todas",
  );
  ...
  return (
    <MainLayout>
      ...
      {/* Player activo */}
      {playing && (
        <div className="mb-6 bg-itec-card border border-itec-border/50 rounded-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="aspect-video bg-black flex items-center justify-center relative">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-itec-red/20 flex items-center justify-center mx-auto mb-3">
                <div className="w-8 h-8 text-[#e01540]">
                  <Icons type="playFill" className="w-full h-full" />
                </div>
              </div>
          ...
          <div className="p-4 flex items-start justify-between gap-3">
            <div>
              <h3 className="text-sm font-semibold text-itec-text">
                {playing.title}
              </h3>
              <p className="text-xs text-[#5a6475] mt-1">
                {playing.author} · {playing.duration}
              </p>
            </div>
            <button
              onClick={() => setPlaying(null)}
              className="text-[#5a6475] hover:text-itec-text shrink-0 text-xl"
            >
              ×
            </button>
          </div>
          ...
          <button
            ...
            className={`shrink-0 px-3.5 py-1.5 rounded-full text-xs font-medium transition-colors border ${
              activeCategory === c
                ...
                : "bg-transparent border-itec-border/50 text-[#9aa3b0] hover:border-itec-border/50"
            }`}
          >
            {c}
          </button>
      ...
      {pinned.length > 0 && (
        <div className="mb-5">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-4 h-4 text-[#f0b100]">
              <Icons type="pin" className="w-full h-full" />
            </div>
            <span className="text-xs font-medium text-[#9aa3b0] uppercase tracking-wider">
              Anclados para ingresantes
            </span>
          </div>
...
const VideoCard = ({
  ...
  <button
    onClick={onPlay}
    className="text-left w-full bg-itec-card border border-itec-border/50 hover:border-itec-border/50 rounded-xl p-3.5 flex items-center gap-3 transition-colors group"
  >
    ...
    <div className="flex-1 min-w-0">
      ...
      <div className="flex items-center gap-2 mt-1">
        ...
        <div className="w-3 h-3 text-[#5a6475]">
          <Icons type="clock" className="w-full h-full" />
        </div>
        <span className="text-xs text-[#5a6475]">{video.duration}</span>
      </div>
    </div>
    <span
      className={`text-[10px] font-medium px-2 py-1 rounded-md shrink-0 hidden sm:inline ${catColors[video.category]}`}
    >
      {video.category}
    </span>
  </button>
